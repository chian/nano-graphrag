...
The current reward intentionally avoids treating table-record growth as a
success metric.  It rewards distinct declared field/value facts, source-backed
field/value support, accepted best-guess slots, and new cited sources, then
penalizes repeated source support for field/value facts that have already
reached the support-depth target.
