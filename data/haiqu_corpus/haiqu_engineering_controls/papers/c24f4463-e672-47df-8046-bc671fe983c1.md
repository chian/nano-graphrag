Dynamics of Airborne Influenza A Viruses Indoors and
...
Citation: Yang W, Marr LC (2011) Dynamics of Airborne Influenza A Viruses Indoors and Dependence on Humidity. PLoS ONE 6(6): e21481. doi:10.1371/
journal.pone.0021481

Editor: Ron A. M. Fouchier, Erasmus Medical Center, The Netherlands

Received March 8, 2011; Accepted May 30, 2011; Published June 24, 2011
...
Copyright: 2011 Yang and Marr. This is an open-access article distributed under the terms of the Creative Commons Attribution License, which permits
unrestricted use, distribution, and reproduction in any medium, provided the original author and source are credited.

Funding: This research was supported by the National Science Foundation under grant number CBET-0547107. No additional external funding was received for
...
- E-mail: [lmarr@vt.edu](mailto:lmarr@vt.edu)
...
The second variable that is sensitive to humidity is IAV viability is possible that the two variables—final droplet size and viability—
...
the studies reported GMs in a much narrower range of 8.4 mmto
...
where Diis the initial droplet diameter in mm, and z is the
...
| Activity | Droplet size(μm) |  | Droplet number | Experimental conditions | Measurement methods | Adjustment for evaporationb | Reference |
| --- | --- | --- | --- | --- | --- | --- | --- |
| GM(GSD)a | Range |  |  |  |  |  |  |
| Cough | $12.1(2.6)^{c}$ | $1-2000 | 5000 | NA | Microscope | Factor of 4 | \[20\] |
| $16.0(5.8)^{d}$ | $1\\rightarrow 1471 | 466 | NA | Bone paper and 0.45-μm filter | As measured | \[15\] |  |
| $0.5(1.7)^{e}$ | <0.6-2.5 | 420 | 24℃,45%RH;35℃,23%RH | Optical particle counter(OPC),electron microscope | As measured | \[16\],\[22\] |  |
...
| $13.5^{f}$ | $2-1000 | NA | 24.9℃,73.9%RH | Interferometric Mie imaging(>2μm),particle image velocimetry | As measured | \[6\] |  |
| $1.8^{g}$ | $0.3-20 | NA | 27℃,59.4%RH | Expiratory droplet investigation system,APS | As measured | \[18\] |  |
| $96.6(2.4)^{h}$ | $0-1500 | 42 | 28℃,70%RH | Microscope,aerosol spectrometer | Factor of 3 | \[19\] |  |
| Sneeze | $8.2(2.3)^{c}$ | $1-2000 | 1\\times10^{6}$ | $NA | Microscope | Factor of 4 | \[20\] |
| Speaki | $11.9(2.8)^{c}$ | $1-1000 | 252 | NA | Microscope | Factor of 4 | \[20\] |
| $16^{f}$ | $2-1000 | NA | 24.9℃,73.9%RH | Interferometric Mie imaging(>2μm),particle image velocimetry | As measured | \[6\] |  |
| $62.1(1.8)^{h}$ | $0-1000 | 253 | 28℃,70%RH | Microscope,aerosol spectrometer | Factor of 3 | \[19\] |  |
...
d
Calculated from data in Table 1 in \[15\]; droplet diameter upper end assumed to be 2000 mm.
e
...
a cough, adapted from Duguid \[20\]. Diis the initial droplet size in
...
diameter in less than half a second at 20uC \[22\]. Table 2 shows the
equilibrium, or final, diameters (Deq
and 10 mm at 10–90% RH. These were calculated based on a

diameter in less than half a second at 20uC \[22\]. Table 2 shows the
) of droplets with Diof 0.1, 1,
and 10 mm at 10–90% RH. These were calculated based on a
...
evaporation of smaller droplets is enhanced, and the equilibrium
diameters are smaller. The ratio Deq
respiratory droplet with Di= 0.1 mm, versus 0.516 under the same
conditions for a larger one with Di=10 mm. However, the Kelvin
effect is negligible for droplets with
independent of RH for droplets larger than 1 mm.

evaporation of smaller droplets is enhanced, and the equilibrium
/Diis 0.490 at 90% RH for a
= 0.1 mm, versus 0.516 under the same
=10 mm. However, the Kelvin
effect is negligible for droplets with Di.0.1 mm, and Deq/Diis
independent of RH for droplets larger than 1 mm.
...
with an r2 of 0.977 and p-values for the model, intercept, and slope
...
associated with droplets of a specific diameter Deqin a room at
time t is

C!=!C\_{0}\\exp\[-(\\frac{\\nu}{H}!+!\\lambda!+!k)t\]

where C0 is the initial concentration of infectious IAVs associated
with droplets of size Deqin the room, v is the settling velocity, H is
the height of the room, l is the air exchange rate (AER) and
assumes no recirculation, and k is the inactivation
...
3 can be integrated over all droplet sizes

is the initial concentration of infectious IAVs associated
in the room, v is the settling velocity, H is
the height of the room, l is the air exchange rate (AER) and
inactivation rate. The
inactivation rate k depends on RH, according to Eq. 2, and the
, which also depends on RH. Eq.
to obtain the total
...
| RH | Model-based $ D\_{eq}/D\_{i} $ ratios$ ^{a}$ |  |  | Experimentally derived $ D\_{eq}/D\_{i} $ ratios$ ^{b}$ | Diff. $ ^{c} $ |
| --- | --- | --- | --- | --- | --- |
| $ D\_{i}=0.1\\mu m $ | $ D\_{i}=1\\mu m $ | $ D\_{i}=10\\mu m $ |  |  |  |
...
| 50% | 0.422 | 0.423 | 0.424 | 0.427 | -0.90% |
| 60% | 0.429 | 0.431 | 0.432 | 0.437 | -1.19% |
| 70% | 0.439 | 0.443 | 0.444 | 0.449 | -1.20% |
...
\\mathtt{r a t i o s^{b}}

D\_{i}{}=10\ \\upmu.

* * *

Figure 2. IAV inactivation rate versus RH. k)
for each RH over 1 h were calculated basedIAV inactivation rates ( on experimental data
...
Figure 3 shows the evolution of IAV concentrations in time in
terms of both the total number of infectious viruses (Figure 3A and
...
3 23
IAVs is initially 1.8610 # m under the assumptions of this
...
3
\[30\], then the concentration of IAVs will be ,2610 # m23 in a
...
1.8,\\times\\,10^{3}#,\\mathrm{m}^{-3}

\\bar{\\sim}2\\times10^{3}#\\dot{\\mathrm m}^{-3}
...
3
by a factor of 8 (2) as its diameter shrinks by half. For instance,
...
the shifting of the peak of DC/DDeqto the left in Figure 3C and
...
of RH on size distributions of
infectious IAVs, 10 min after a cough in residential and public
IAV concentrations decrease with
increasing RH across all sizes, but the modes of the distributions
remain around 9–10 mm. The total IAV concentration (i.e., the
area under each curve) decreases with increased RH. As a result, it
takes twice as long to remove 99.9% of IAVs emitted at 10% RH
...
proportional to the initial droplet volume, or Di3. However,
...
removal by ventilation and settling are both minor. For instance,
in residential settings (Figure 5C), inactivation accounts for ,50%
of total removal of IAVs associated with droplets ,5 mm.

Discussion

Figure 4. IAV size distributions. Infectious IAV size distributions at various RHs in residential (A) and public (B) settings with a volume of 50 m3
...
accelerate the removal of infectious IAVs and help prevent or
reduce influenza infection.
...
influenza transmission by influencing the virus’ survival rate, rather than
...
unsaturated RHs is not important for influenza transmission, only that it
is not as obvious as the induced change in viability.
We have demonstrated the relative importance of the three removal
...
indicated lower inactivation rates of 0.0031–0.028 min21 at 20–81%
RH, compared to 0.007360.0031 min21 at 15–40% RH and
0.09160.024 min21 at 50–90% RH, as reported by Hemmes \[2\].
...
Harper \[12\] found higher inactivation rates at both medium and high
...
more proteins than did those in the latter two. High concentrations of
saltsarefoundtobedetrimentaltoavianIAVs\[36\].Aswaterinthe
droplets evaporates, solute concentrations increase and may

IAV viability, seasonality, and humidity dependency
Experimental and/or theoretical models have been constructed to

0.091{\\pm}0.024\ mathrm i i n^{-1} consequently accelerate IAV inactivation. However, an NaCl droplet
can suddenly lose all of its water and crystallize at the point of
...
which shows that Deq/Divaries little when RH#40%. The
combination of increasing salt concentrations followed by efflorescence as RH decreases may explain the trend observed by
...
this assertion: 64% of the IAV genomes detected in a daycare center,
...
can remain suspended for hours to days. Because of the many factors
...
size with the highest deposition efficiency (,95%) in all regions of the
...
with the highest deposition efficiency (,17%) in the tracheobronchial and alveolar regions is ,2.5 mm \[39\]. Thus these smaller
...
conditions. On the other hand, saliva has much lower concentrations of salts and glycoproteins \[43,44\], due to dilution by which
...
Third, we calculated the IAV concentration based on a wellmixed room model with no recirculation. This model assumes that
droplets are instantaneously, continuously, and evenly distributed
throughout the room. However, according to Lai and Cheng \[45\], it
...
lower AERs. More accurate calculations may be achieved by the use
...
to 20 RNA particles min21. These droplets were smaller than
those associated with a cough; over 87% of them were ,1 mmin
...
during talking, although to our knowledge, no detailed experimental data on this phenomenon are currently available in the
...
Equations for generating the initial respiratory droplet
size distributions
...
(\\leq100~\\upmu\\mathrm{m})

n\_{i}=N\\times(N O R M S D I S T(z\_{i,u p p e r})-N O R M S D I S T(z\_{i,l o v e r}))

ð4Þ

where niis the droplet count in the ith size bin (5-mm step in this
study), N is the total number of droplets #100 mm (i.e., 4775
according to Duguid \[20\]), and zi, upperand zi, lowerare the upper
...
9!\\pm8,(\\mathrm{N a}),60!\\pm!1,(\\mathrm{K})
...
76.3{\\pm}\ !{\ \ !}8.2~\\mathrm{g}L^{-1}

(8.8;\\mathrm{g g}L^{-1mathrm{)l}}
...
done in Mikhailov et al. \[23\], i.e., 0.072 N m21); M is the molar
mass, the subscripts w and y refer to water and component y (either
NaCl or TP), respectively, and Mw= 18 g mol21, MNaCl= 58.4 g
3
mol21, MTP<MBSA= 66.5610 g mol21; r, rw, ryare the
densities of the entire droplet, water, and component y
(rNaCl= 2165 kg m23, rTP<rBSA= 1362 kg m23), respectively; R
is the ideal gas constant; T is the absolute temperature (298 K in
this study); Deqis the equilibrium diameter of a droplet residue at a
given RH; Dm,sis the mass equivalent diameter of a particle
consisting of the dry solutes; uyis the stoichiometric dissociation
number of component y, uNaCl= 2, and uTP= uBSA=1; Wyis the
molal or practical osmotic coefficient of component y describing
the non-ideality of the solution; and xs,yis the mass fraction of
...
\\stackrel{\\mathrm{\ \ \ \ \ }}{0.072}mathrm~mathrm{N}\\mathrm{\ m{{}{}}}{\ \\vec{m}^{-1}});

S\_{t}

R H!=!\\exp!(\\frac{4\\sigma M\_{w}}{\\rho R T D\_{e q}}!-!\\frac{M\_{w}}{\\rho\_{w}!(!(D\_{e q}!-!D\_{m,s})!\ ^{3}!-!1)}!\\sum\_{y}\\frac{\\nu\_{y}\\Phi\_{y}\\rho\_{y}x\_{s,y}}{M\_{y}})

D\_{m,}

^{-1},,M\_{T P}^{'}{\\approx}\\dot{M\_{B S A}}=66.5\\times10^{3}\

\ (\\rho\_{\\mathrm{N a C}}!=,2,165\ \\mathrm{k g\ m^{-3}},\ \\rho\_{\\mathrm{T T}}!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\
...
as an input to further calculate Deqwith its equilibrium RH.

D\_{m,s},

\\scriptstyle\\chi\_{T P}=0.896
...
inactivation rate (k)is

k=-,\\frac{\\ln{(\\frac{N\_{t}}{N\_{0}})}}{t}=-,\\frac{\\ln S\_{t}}{t}

t!=!0

(k)

where N0 and Ntare the numbers of IAVs at t =0andtimet,andStis
the survival rate, or viability (%) at time t. Accordingly, we computed
k for each RH from the Stdata reported by Harper \[12\] using the
SLOPE function in Excel 2007 (Table 3). The equation of the leastsquares linear regression between k and RH is shown in Eq. 2.
...
complete at time zero, and Deqwas used for the calculation.
...
C\_{i,0}!=!0.778\\times6.3\\times10^{-3}\\times(\\frac{\\pi}{24}\\times\\frac{D\_{i,u p p e r}^{4}-!!D\_{i,l o w e r}^{4}}{D\_{i,u p p e r}-!!D\_{i,l o w e r}})(\\frac{n\_{i}}{V})

where C is the infectious IAV concentration in the room and
outflow (# m23); v is the gravitational settling velocity calculated
...
23
rate at 1 s according to the results of Harper \[12\]); 6.3610 is the
IAV concentration in respiratory fluid (# mm23) obtained by
...
Table 3. Inactivation of airborne IAVs at 20–24.5uC over 1 h.

|  | Viability($S\_{i}$) at different RH$s^{a}$ |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
|  | 20-22% | 34-36% | 50-51% | 64-65% | 81% |
| 0.017(1s) | 0.75 | 0.86 | 0.84 | 0.77 | 0.67 |
| 5 | 0.77 | 0.93 | 0.62 | 0.45 | 0.55 |
| 30 | 0.65 | 0.58 | 0.49 | 0.29 | 0.22 |
| 60 | 0.64 | 0.59 | 0.29 | 0.15 | 0.13 |
| Inactivation rate |  |  |  |  |  |
| RHb | 21% | 35% | 51% | 65% | 81% |
| kc | 0.0031 | 0.0078 | 0.016 | 0.024 | 0.028 |
| Interceptd | -0.28 | -0.14 | -0.27 | -0.47 | -0.48 |
| r2e | 0.82 | 0.74 | 0.96 | 0.94 | 0.97 |

k^{\\mathrm{c}}

a
Experimental data from Harper \[12\].
b
Average RH.
...
Average RH.
c
k = slope of ln(St) versus t.
d
Intercept of the plot of ln(S

k = slope of ln(St) versus t.
d
Intercept of the plot of ln(St) versus t.
e
r2 of the plot of ln(S) versus t.

Intercept of the plot of ln(St) versus t.
e
r2 of the plot of ln(St) versus t.
doi:10.1371/journal.pone.0021481.t003

r2 of the plot of ln(St) versus t.
doi:10.1371/journal.pone.0021481.t003

(6.3{\\pm}0.3\ \\times{}10^{6}

6
tion of IAV as in nasal washes of infected persons (6.360.3610
21
median tissue culture infectious dose (TCID50)mL \[49\]) and
...
and Di,lowerare, respectively, the upper and lower diameters of the
ith size bin (mm); niis the droplet count for the ith size bin given in
Eq. 4, and V is the room volume (assumed to be 50 m3). The
solution for C is given in Eq. 3.

(mathrm{T C I D}\_{50}),{\\mathrm{m L}}^{-1}
...
E\_{s e t t l i n g},1-\\exp{(-\\frac{\\nu}{H}t)}
...
7. Effros RM, Hoagland KW, Bosbous M, Castillo D, Foss B, et al. (2002) Dilution of
   respiratory solutes in exhaled condensates. Am J Respir Crit Care Med 165: 663–669.
...
10. Shechmeister IL (1950) Studies on the experimental epidemiology of respiratory
   infections: III. Certain aspects of the behavior of type A influenza virus as an airborne cloud. J Infect Dis 87: 128–132.
...
E\_{i n a c t i v a t i o n}{=},{\\tt I x p}\\left(-k t\\right)

E\_{t o t a l}!=!1-\\exp\[-(\\frac{\\nu}{H}t!+!\\lambda!+!k)t\\
\
Acknowledgments\
\
Conceived and designed the experiments: WY LCM. Performed the\
experiments: WY. Analyzed the data: WY LCM. Wrote the paper: WY\
LCM.\
\
* * *\
\
...
\
17. Papineni RS, Rosenthal FS (1997) The size distribution of droplets in the\
    exhaled breath of healthy human subjects. J Aerosol Med 10: 105–116.\
\
18. Yang S, Lee GWM, Chen C-M, Wu C-C, Yu K-P (2007) The size and\
\
19. Yang S, Lee GWM, Chen C-M, Wu C-C, Yu K-P (2007) The size and\
    concentration of droplets generated by coughing in human subjects. J Aerosol\
    Med 20: 484–494.\
\
20. Morawska L, Johnson GR, Ristovski ZD, Hargreaves M, Mengersen K, et al.\
\
21. Morawska L, Johnson GR, Ristovski ZD, Hargreaves M, Mengersen K, et al.\
...
\
22. Xie X, Li Y, Sun H, Liu L (2009) Exhaled droplets due to talking and coughing.\
\
23. Xie X, Li Y, Sun H, Liu L (2009) Exhaled droplets due to talking and coughing.\
    J R Soc Interface 6: S703–S714.\
\
24. Duguid JP (1946) The size and the duration of air-carriage of respiratory\
\
25. Duguid JP (1946) The size and the duration of air-carriage of respiratory\
    droplets and droplet-nuclei. J Hyg 44: 471–479.\
\
26. Tang JWT, Tambyah PA, Lai FYL, Lee HK, Lee CK, et al. (2010) Differing\
\
\
droplets and droplet-nuclei. J Hyg 44: 471–479.\
...
\
27. Bagger H, Fuglsang C, Westh P (2006) Hydration of a glycoprotein: Relative\
    water affinity of peptide and glycan moieties. Eur Biophys J 35: 367–371.\
\
28. Jensen MM (1964) Inactivation of airborne viruses by ultraviolet irradiation.\
\
29. California Building Standards Commission (2007) 2007 California mechanical\
    code (part 4, title 24, California code of regulations).\
\
30. McDevitt J, Rudnick S, First M, Spengler J (2010) Role of absolute humidity in\
...
\
31. Brown JD, Goekjian G, Poulson R, Valeika S, Stallknecht DE (2009) Avian\
    influenza virus in water: Infectivity is dependent on pH, salinity and\
    temperature. Vet Microbiol 136: 20–26.\
\
32. Parker ER, Dunham WB, MacNeal WJ (1944) Resistance of the melbourne\
    strain of influenza virus to desiccation. J Lab Clin Med 29: 37–42.\
\
33. Thomas Y, Vogel G, Wunderli W, Suter P, Witschi M, et al. (2008) Survival of\
    influenza virus on banknotes. Appl Environ Microbiol 74: 3002–3007.\
\
34. Oberdorster G, Oberdorster E, Oberdorster J (2005) Nanotoxicology: An\
    emerging discipline evolving from studies of ultrafine particles. Environ Health\
    Perspect 113: 823–839.\
\
35. Lowen AC, Steel J, Mubareka S, Palese P (2008) High temperature (30uC)\
    blocks aerosol but not contact transmission of influenza virus. J Virol 82:\
    5650–5652.\
\
36. Lowen A, Palese P (2009) Transmission of influenza virus in temperate zones is\
    predominantly by aerosol, in the tropics by contact: A hypothesis. PLoS Curr 1:\
    RRN1002.\
\
37. Fischer H, Widdicombe JH (2006) Mechanisms of acid and base secretion by the\
    airway epithelium. J Membr Biol 211: 139–150.\
\
38. Enberg N, Alho H, Loimaranta V, Lenander-Lumikari M (2001) Saliva flow\
    ...
    Endod 92: 292–298.\
\
39. Michishige F, Kanno K, Yoshinaga S, Hinode D, Takehisa Y, et al. (2006) Effect\
    of saliva collection method on the concentration of protein components in saliva.\
    J Med Invest 53: 140–146.\
\
40. Lai ACK, Cheng YC (2007) Study of expiratory droplet dispersion and transport\
    using a new eulerian modeling approach. Atmos Environ 41: 7473–7484.\
\
41. Fabian P, McDevitt JJ, DeHaan WH, Fung ROP, Cowling BJ, et al. (2008)\
    Influenza virus in human exhaled breath: An observational study. PLoS ONE 3:\
    e2691.\
\
42. Douglas Jr. RG (1975) Influenza in man. In: Kilbourne ED, ed. The influenza\
    viruses and influenza. New York: Academic Press. pp 395–447.\
\
43. Lindsley WG, Blachere FM, Thewlis RE, Vishnu A, Davis KA, et al. (2010)\
    Measurements of airborne influenza virus in aerosol particles from human\
    coughs. PLoS ONE 5: e15100.\
\
44. Murphy BR, Rennels MB, Douglas RG, Jr., Betts RF, Couch RB, et al. (1980)\
    Evaluation of influenza A/Hong Kong/123/77 (H1N1) ts-1A2 and coldadapted recombinant viruses in seronegative adult volunteers. Infect Immun 29:\
    348–355.\
\
45. Ward CL, Dempsey MH, Ring CJA, Kempson RE, Zhang L, et al. (2004)\
...
\
46. Hinds WC (1999) Aerosol technology. 2nd ed. New York: Wiley. pp 75–110.\
\
\
water affinity of peptide and glycan moieties. Eur Biophys J 35: 367–371.\
...
\
31. Yamamoto N, Shendell DG, Winer AM, Zhang J (2010) Residential air\
    ...
    Air 20: 85–90.\
\
32. Tompkins JA, White JA, Bozer YA, Tanchoco JMA (2010) Facilities planning:\
\
33. Myatt TA, Kaufman MH, Allen JG, MacIntosh DL, Fabian MP, et al. (2010)\
...
\
34. Blachere FM, Lindsley WG, Pearce TA, Anderson SE, Fisher M, et al. (2009)\
\
35. Lindsley WG, Blachere FM, Davis KA, Pearce TA, Fisher MA, et al. (2010)\
...
\
36. Yang W, Subbiah E, Marr LC (2011) Concentrations and size distributions of\
\
37. Blachere FM, Lindsley WG, Pearce TA, Anderson SE, Fisher M, et al. (2009)\
    Measurement of airborne influenza virus in a hospital emergency department.\
    Clin Infect Dis 48: 438–440.\
\
38. Lindsley WG, Blachere FM, Davis KA, Pearce TA, Fisher MA, et al. (2010)\
\
39. Yang W, Subbiah E, Marr LC (2011) Concentrations and size distributions of\
