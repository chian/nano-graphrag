"""A table-specific Episode over structured regions of one fetched source.

This binding does not call the lexical-probe or chunk bindings. It detects
table-shaped regions, asks a model for a constrained parser specification,
executes that specification deterministically, and then issues one adaptive
row query per Episode turn. The model supplies parser and query strings; the
attached numerical controller alone decides whether another query is made.
"""
...
from ..costs import ObservationKind
